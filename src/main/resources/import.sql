...
INSERT INTO tb_user(id,username,password,role,enabled) values (2,'pedrito','$2a$10$t7hdNZRDTsU6OOC46y3DO.XA7TR36b1EyGd7qKSjQvlCP5kCXoW6m','ROLE_ALUNO', true);
...
INSERT INTO ALUNO (id, nome,user_id) VALUES (1, 'Pedro',2);
